                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <hr className='my-5' />
                            <div className="flex">
                                <span className="title-font font-bold text-4xl text-gray-900">${price}</span>
                                <Link to='' onClick={() => handleAddToCart(food)} className='flex ml-auto'>
                                    <button className=" text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 font-bold rounded">Add To Cart</button>
                                </Link>
