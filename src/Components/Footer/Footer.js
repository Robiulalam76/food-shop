...
const Footer = () => {
    return (
        <div className=''>
            ...
            <footer class="bg-blue-200 text-black px-10 pt-20 lg:pt-[120px] pb-10 lg:pb-20 relative z-10">
                <div class="container">
                    <div class="flex flex-wrap -mx-4">
                     ...
                     "
                                    ...
                                    <a target="_blank"
                                        href="https://www.linkedin.com/in/robiulalam762/"
                                        class="
                     w-8
                     h-8
                     flex
                     ...
                     "
                                ...
                                <p class="text-base text-body-color">&copy; 2025 Food Shop</p>
                            </div>
                        </div>
                    </div>
                </div>
